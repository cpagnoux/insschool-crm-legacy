...
function checkbox_followed_quarters($plan = null, $followed_quarters_str = null)
{
	...
	require 'app/views/checkbox_followed_quarters.html.php';
}
...
function radio_insurance($insurance = null)
{
	...
	require 'app/views/radio_insurance.html.php';
}
...
function radio_medical_certificate($medical_certificate = null)
{
	...
	require 'app/views/radio_medical_certificate.html.php';
}
...
function radio_mode($mode = null)
{
	...
	require 'app/views/radio_mode.html.php';
}
...
function radio_photo($photo = null)
{
	...
	require 'app/views/radio_photo.html.php';
}
...
function radio_plan($plan = null)
{
	...
	require 'app/views/radio_plan.html.php';
}
...
function radio_stamped_envelope($stamped_envelope = null)
{
	...
	require 'app/views/radio_stamped_envelope.html.php';
}
...
function radio_with_lessons($with_lessons = null)
{
	...
	require 'app/views/radio_with_lessons.html.php';
...
function select_date($label, $prefix, $required, $date = null)
{
	...
	require 'app/views/select_date.html.php';
}
...
function select_day($day = null)
{
	...
	require 'app/views/select_day.html.php';
}
...
function select_goody()
{
	...
	require 'app/views/select_goody.html.php';
...
function select_lesson()
{
	...
	require 'app/views/select_lesson.html.php';
				   ...
				   $means_of_knowledge = null)
{
	...
	require 'app/views/select_means_of_knowledge.html.php';
}
...
function select_member()
{
	...
	require 'app/views/select_member.html.php';
...
function select_room($room_id)
{
	...
	require 'app/views/select_room.html.php';
...
function select_teacher($teacher_id)
{
	...
	require 'app/views/select_teacher.html.php';
...
function select_time($label, $prefix, $time = null)
{
	...
	require 'app/views/select_time.html.php';
}
