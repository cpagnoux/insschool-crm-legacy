...
<div class="super-container">
  ...
  <div class="member-counter">
    ...
    Bénéfice sur les inscriptions : <?php echo earnings_from_registrations(current_season()) ?> €<br>
    Nombre de goodies vendus : <?php echo total_goodies_sold(current_season()) ?><br>
    Bénéfice sur les commandes : <?php echo earnings_from_orders(current_season()) ?> €
  </div>
</div>
