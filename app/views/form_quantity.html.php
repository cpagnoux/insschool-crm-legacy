...
<form action="<?php echo $_SERVER['SCRIPT_NAME'] ?>?controller=entity&amp;action=modify_quantity&amp;order_id=<?php echo $order_id ?>&amp;goody_id=<?php echo $row['goody_id'] ?>" method="post">
