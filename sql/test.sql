INSERT INTO ins_school.contains VALUES (1, 1, 1),
	(1, 3, 1),
	(2, 5, 1),
	(2, 2, 1);

INSERT INTO ins_school.file VALUES ('', 1, 0, 1, 0),
	('', 2, 0, 1, 1);

INSERT INTO ins_school.goody VALUES ('', 'DVD INS Show 2015', '', 12.00, 500),
...
INSERT INTO ins_school.lesson VALUES ('', 'Ragga Dancehall Débutant', 0, 'LUNDI', '18:30:00', '19:30:00', 1, '', ''),
...
INSERT INTO ins_school.member VALUES ('', 'Christophe', 'Pagnoux-Vieuxfort', '1992-03-27', '7 Avenue de l\'Union Soviétique', '63000', 'Clermont-Ferrand', '0661081798', '', '', '0981825328', 'christophe.pagnouxv@gmail.com', 1),
...
INSERT INTO ins_school.order VALUES ('', 1, '2016-02-15'),
	('', 2, '2016-03-27');

INSERT INTO ins_school.participates VALUES (1, 6, ''),
	(1, 28, ''),
	(1, 29, ''),
	(2, 27, ''),
	(2, 29, '');

INSERT INTO ins_school.payment VALUES ('', 1, 'CHQ', 130.00, '2011-09-15'),
...
INSERT INTO ins_school.registration VALUES ('', 1, '2011-2012', 4, 380.00, 0, 3),
	('', 1, '2012-2013', 3, 340.00, 10, 3),
	('', 1, '2013-2014', 4, 10.00, 0, 1),
	('', 1, '2015-2016', 2, 0.00, 0, 0),
	('', 2, '2015-2016', 1, 0.00, 0, 0);

INSERT INTO ins_school.room VALUES ('', 'Salle du Temps', '29 Rue Jules Verne', '63100', 'Clermont-Ferrand', 1),
	('', 'Salle Afrika Bambaataa', '29 Rue Jules Verne', '63100', 'Clermont-Ferrand', 2);

INSERT INTO ins_school.teacher VALUES ('', 'François', 'Khamny', '', '', '', '', '', '', ''),
	('', 'Djamel', 'Dahak', '', '', '', '', '', '', '');
