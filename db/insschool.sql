...
-- sam. 03 sept. 2016 22:55:29 CEST
...
CREATE TABLE IF NOT EXISTS `insschool`.`member` (
  ...
  UNIQUE INDEX `last_name_UNIQUE` (`last_name` ASC, `first_name` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `insschool`.`registration` (
  ...
  UNIQUE INDEX `member_id_UNIQUE` (`member_id` ASC, `season` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `insschool`.`lesson` (
  ...
  UNIQUE INDEX `day_UNIQUE` (`day` ASC, `start_time` ASC, `end_time` ASC, `room_id` ASC),
...
CREATE TABLE IF NOT EXISTS `insschool`.`pre_registration` (
  ...
  INDEX `last_name_idx` (`last_name` ASC, `first_name` ASC))
ENGINE = InnoDB;
